...
export function HomeHeroSection() {
    ...
    const imageSrc = resolvedTheme === "light" ? "/app-light.png" : "/app-dark.png";
    ...
    return (
        <section className="w-full overflow-hidden px-4 flex flex-col items-center">
            <header className="mx-auto max-w-3xl text-balance flex flex-col items-center text-center my-20 sm:my-28 z-10">
                ...
                <div className="py-2 pb-4 text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-monaSans font-extrabold leading-none tracking-tighter text-balance m-0 bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent drop-shadow-2xl">
            ...
            <div className="relative mx-auto max-w-7xl">
                <MockupFrame size="small">
                    <Mockup type="responsive">
                        <Image src={imageSrc} alt="app-demo" width={1248} height={765} priority />
                    </Mockup>
                </MockupFrame>
                <Glow variant="top" />
            </div>
